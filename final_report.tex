...
\title{RTL Debugging Agent for Out-of-Order Processor Bugs}
\author{Vayun Gupta}
\date{}
...
stored in the submitted files; the OpenAI key is read from the environment. The
GitHub repository is
\url{https://github.com/Vayung2/rtl-debugging-agent}.

To validate the bug suite:
\begin{lstlisting}[basicstyle=\ttfamily\small]
cd rtl-debugging-agent
